# Terraform Provider for Mandrill
...
### Acceptance Tests
In order to run the full suite of Acceptance tests, start the mock server and run `make testacc`.

```shell
./tools/mock-server/run-server.sh
make testacc
```
